...
@section('content')
    ...
    <div class="row my-3">
        ...
        <div class="d-flex flex-column w-100">
            ...
            <h1 class="order-1">ChatGpt Answer</h1>
            ...
            <form class="searchchatgpt_form w-100 order-2 my-3" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="indicateprompt" class="form-control" id="promptsearch" aria-describedby="ChatGpt Answer" value="{{ old('indicateprompt') }}">
